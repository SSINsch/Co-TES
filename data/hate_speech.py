...
class HateSpeech(data.TensorDataset):
    def __init__(self,
        ...
        self.dataset = 'hate_speech'
        self.num_classes = 3

        if self.train:
            self.train_data, self.train_labels = pickle.load(open(os.path.join(self.root, "Hate_speech_labeled_data-train.pkl"), "rb"), encoding='iso-8859-1')
            ...
            self.test_data, self.test_labels = pickle.load(open(os.path.join(self.root, "Hate_speech_labeled_data-test.pkl"), "rb"), encoding='iso-8859-1')
