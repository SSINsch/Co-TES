...
class ClickBait(data.TensorDataset):
    def __init__(self,
        ...
        self.dataset = 'click_bait'
        self.num_classes = 2

        if self.train:
            self.train_data, self.train_labels = pickle.load(open(os.path.join(self.root, "clickbait-train.pkl"), "rb"), encoding='iso-8859-1')
            ...
            self.test_data, self.test_labels = pickle.load(open(os.path.join(self.root, "clickbait-test.pkl"), "rb"), encoding='iso-8859-1')
