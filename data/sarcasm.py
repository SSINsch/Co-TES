...
class Sarcasm(data.TensorDataset):
    def __init__(self,
        ...
        self.dataset = 'sarcasm'
        self.num_classes = 2

        if self.train:
            self.train_data, self.train_labels = pickle.load(open(os.path.join(self.root, "sarcasm-train.pkl"), "rb"), encoding='iso-8859-1')
            ...
            self.test_data, self.test_labels = pickle.load(open(os.path.join(self.root, "sarcasm-test.pkl"), "rb"), encoding='iso-8859-1')
