...
class Sentiment(data.TensorDataset):
    def __init__(self,
        ...
        if self.train:
            self.train_data, self.train_labels = pickle.load(open(os.path.join(self.root, "sentiment140-train_sample.pkl"), "rb"), encoding='iso-8859-1')
            ...
            self.test_data, self.test_labels = pickle.load(open(os.path.join(self.root, "sentiment140-test_sample.pkl"), "rb"), encoding='iso-8859-1')
