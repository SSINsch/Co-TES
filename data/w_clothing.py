...
class WomenClothing(data.TensorDataset):
    def __init__(self,
        ...
        self.dataset = 'w_clothing'
        self.num_classes = 5

        if self.train:
            self.train_data, self.train_labels = pickle.load(open(os.path.join(self.root, "w_clothing-train.pkl"), "rb"), encoding='iso-8859-1')
            ...
            self.test_data, self.test_labels = pickle.load(open(os.path.join(self.root, "w_clothing-test.pkl"), "rb"), encoding='iso-8859-1')
